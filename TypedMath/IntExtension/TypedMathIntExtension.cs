...
namespace MarcusMedinaPro.TypedMath.IntExtension
{
    ...
    public static class TypedMathIntExtension
    {
        ...
        /// </summary>
        /// <returns>The result of the operation</returns>
        public static int GetLastValue(this int[] array) => array[array.Length - 1];
        ...
        public static int[] GetValuesHigherThan(this int[] array, int x) => array.Where(y => y >= x).ToArray();
        ...
        public static int[] GetValuesLowerThan(this int[] array, int x) => array.Where(y => y <= x).ToArray();
        ...
        public static int[] SortArrayAsc(this int[] array) => array.OrderBy(x => x).ToArray();

        /// <summary>
        /// Sorts array from highest to lowest
        /// </summary>
        /// <returns>A sorted array</returns>
        public static int[] SortArrayDesc(this int[] array) => array.OrderByDescending(x => x).ToArray();
        ...
        /// <returns>
        /// The System.int[] requested
        /// </returns>
        /// Borrowed from https://stackoverflow.com/questions/823532/apply-function-to-all-elements-of-collection-through-linq
        public static int[] IncreaseAllValuesWith(this int[] array, int add) => array.Select(x => x + add).ToArray();
        ...
        /// </returns>
        /// Borrowed from https://stackoverflow.com/questions/823532/apply-function-to-all-elements-of-collection-through-linq
        public static int[] DecreaseAllValuesWith(this int[] array, int dec) => array.Select(x => x - dec).ToArray();
        ...
        /// The System.int[] requested
        /// </returns>
        public static int[] GetFirstHalf(this int[] array) => array.Take(array.Length / 2).ToArray();
        ...
        /// The System.int[] requested
        /// </returns>
        public static int[] GetLastHalf(this int[] array) => array.Skip(array.Length / 2).Take(array.Length / 2).ToArray();
        ...
        /// The System.int[] requested
        /// </returns>
        public static int[] GetMiddle(this int[] array) => array.Skip(array.Length / 4).Take(array.Length / 2).ToArray();
