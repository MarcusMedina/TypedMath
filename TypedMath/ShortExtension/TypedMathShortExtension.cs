...
namespace MarcusMedinaPro.TypedMath.ShortExtension
{
    ...
    public static class TypedMathShortExtension
    {
        ...
        /// <param name="array">The array<see cref="short[]"/></param>
        /// <returns>The result of the operation</returns>
        public static short GetLastValue(this short[] array) => array[array.Length - 1];
        ...
        public static short[] GetValuesHigherThan(this short[] array, short x) => array.Where(y => y >= x).ToArray();
        ...
        public static short[] GetValuesLowerThan(this short[] array, short x) => array.Where(y => y <= x).ToArray();
        ...
        public static short[] SortArrayAsc(this short[] array) => array.OrderBy(x => x).ToArray();
        ...
        /// <param name="array">The array<see cref="short[]"/></param>
        /// <returns>A sorted array</returns>
        public static short[] SortArrayDesc(this short[] array) => array.OrderByDescending(x => x).ToArray();
        ...
        public static int[] ConvertArrayToInt(this short[] array) => array.Select(x => (int)x).ToArray();
        ...
        /// <param name="array">The array.</param>
        /// <returns>The <see cref="short[]"/></returns>
        public static short[] GetFirstHalf(this short[] array) => array.Take(array.Length / 2).ToArray();
        ...
        /// <param name="array">The array.</param>
        /// <returns>The <see cref="short[]"/></returns>
        public static short[] GetLastHalf(this short[] array) => array.Skip(array.Length / 2).Take(array.Length / 2).ToArray();
        ...
        /// <param name="array">The array.</param>
        /// <returns>The <see cref="short[]"/></returns>
        public static short[] GetMiddle(this short[] array) => array.Skip(array.Length / 4).Take(array.Length / 2).ToArray();
