...
namespace MarcusMedinaPro.TypedMath.DoubleExtension
{
    ...
    public static class TypedMathDoubleExtension
    {
        ...
        /// <returns>The System.Int32[] requested</returns>
        ...
        /// <returns>The System.double[] requested</returns>
        ...
        /// <returns></returns>
        public static double DiferenceFrom(this double original, double compareTo) => original > compareTo ? original - compareTo : original < compareTo ? compareTo - original : 0;
