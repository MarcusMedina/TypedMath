...
namespace MarcusMedinaPro.TypedMath.UintExtension
{
    ...
    public static class TypedMathUintExtension
    {
        ...
        public static int[] ConvertArrayToInt(this uint[] array) => array.Select(x => (int)x).ToArray();
        ...
        /// <returns></returns>
        public static uint DiferenceFrom(this uint original, uint compareTo) => original > compareTo ? original - compareTo : original < compareTo ? compareTo - original : 0;
        ...
        public static uint[] GetFirstHalf(this uint[] array) => array.Take(array.Length / 2).ToArray();

        /// <summary>
        /// Gets the first number in the array
        /// </summary>
        /// <param name="array">The array <see cref="uint[]"/></param>
        /// <returns>The result of the operation</returns>
        public static uint GetFirstValue(this uint[] array) => array[0];
        ...
        /// <param name="array">The array.</param>
        /// <returns>The <see cref="uint[]"/></returns>
        public static uint[] GetLastHalf(this uint[] array) => array.Skip(array.Length / 2).Take(array.Length / 2).ToArray();
        ...
        /// <param name="array">The array <see cref="uint[]"/></param>
        /// <returns>The result of the operation</returns>
        public static uint GetLastValue(this uint[] array) => array[array.Length - 1];
        ...
        /// <param name="array">The array.</param>
        /// <returns>The <see cref="uint[]"/></returns>
        public static uint[] GetMiddle(this uint[] array) => array.Skip(array.Length / 4).Take(array.Length / 2).ToArray();
        ...
        /// <param name="array">The array <see cref="uint[]"/></param>
        /// <returns>The result of the operation</returns>
        public static uint GetMiddleValue(this uint[] array) => array[(array.Length - 1) / 2];
        ...
        public static uint[] GetValuesHigherThan(this uint[] array, uint x) => array.Where(y => y >= x).ToArray();
        ...
        public static uint[] GetValuesLowerThan(this uint[] array, uint x) => array.Where(y => y <= x).ToArray();
        ...
        public static uint[] SortArrayAsc(this uint[] array) => array.OrderBy(x => x).ToArray();
        ...
        /// <param name="array">The array <see cref="uint[]"/></param>
        /// <returns>A sorted array</returns>
        public static uint[] SortArrayDesc(this uint[] array) => array.OrderByDescending(x => x).ToArray();
