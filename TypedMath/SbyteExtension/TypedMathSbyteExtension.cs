...
namespace MarcusMedinaPro.TypedMath.SbyteExtension
{
    ...
    public static class TypedMathSbyteExtension
    {
        ...
        public static int[] ConvertArrayToInt(this sbyte[] array) => array.Select(x => (int)x).ToArray();
        ...
        /// <returns></returns>
        public static sbyte DiferenceFrom(this sbyte original, sbyte compareTo) => (sbyte)(original > compareTo ? original - compareTo : original < compareTo ? compareTo - original : 0);
        ...
        public static sbyte[] GetFirstHalf(this sbyte[] array) => array.Take(array.Length / 2).ToArray();

        /// <summary>
        /// Gets the first number in the array
        /// </summary>
        /// <param name="array">The array <see cref="sbyte[]"/></param>
        /// <returns>The result of the operation</returns>
        public static sbyte GetFirstValue(this sbyte[] array) => array[0];
        ...
        /// <param name="array">The array.</param>
        /// <returns>The <see cref="sbyte[]"/></returns>
        public static sbyte[] GetLastHalf(this sbyte[] array) => array.Skip(array.Length / 2).Take(array.Length / 2).ToArray();
        ...
        /// <param name="array">The array <see cref="sbyte[]"/></param>
        /// <returns>The result of the operation</returns>
        public static sbyte GetLastValue(this sbyte[] array) => array[array.Length - 1];
        ...
        /// <param name="array">The array.</param>
        /// <returns>The <see cref="sbyte[]"/></returns>
        public static sbyte[] GetMiddle(this sbyte[] array) => array.Skip(array.Length / 4).Take(array.Length / 2).ToArray();
        ...
        /// <param name="array">The array <see cref="sbyte[]"/></param>
        /// <returns>The result of the operation</returns>
        public static sbyte GetMiddleValue(this sbyte[] array) => array[(array.Length - 1) / 2];
        ...
        public static sbyte[] GetValuesHigherThan(this sbyte[] array, sbyte x) => array.Where(y => y >= x).ToArray();
        ...
        public static sbyte[] GetValuesLowerThan(this sbyte[] array, sbyte x) => array.Where(y => y <= x).ToArray();
        ...
        public static sbyte[] SortArrayAsc(this sbyte[] array) => array.OrderBy(x => x).ToArray();
        ...
        /// <param name="array">The array <see cref="sbyte[]"/></param>
        /// <returns>A sorted array</returns>
        public static sbyte[] SortArrayDesc(this sbyte[] array) => array.OrderByDescending(x => x).ToArray();
